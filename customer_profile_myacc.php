...
?>
    ...
    $maskedAccountNo = maskNumber($_SESSION['Account_No']);
    $maskedMobileNo = maskNumber($_SESSION['Mobile_no']);
    $maskedDebitCardNo = maskNumber($_SESSION['Debit_Card_No']);
    $maskedNomineeAcNo = maskNumber($_SESSION['Nominee_ac_no']);
?>
...
<div class="cust_myacc_container">
    ...
    <div class="accdet">
        ...
        <label>Account Number : <?php echo $maskedAccountNo; ?></label>
        ...
        <label>Mobile No : <?php echo $maskedMobileNo; ?></label>
        <label>Debit Card No : <?php echo $maskedDebitCardNo; ?></label>
        <label>Nominee Name : <?php echo $_SESSION['Nominee_name']; ?></label>
        <label>Nominee Ac/no : <?php echo $maskedNomineeAcNo; ?></label>
